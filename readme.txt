...
2. Navigate to the theme directory in your WordPress installation: `wp-content/themes/your-theme-folder`.

3. Open your command line interface (e.g., Command Prompt, Terminal) and navigate to the theme folder.
...
5. Once the installation is complete, you can start the theme and enable live reload using the following command:
   ```
   npm start
   ```
